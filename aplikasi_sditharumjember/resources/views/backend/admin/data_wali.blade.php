    ...
    <table class="table table-hover" id="datatable">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{$data->alamat}}</td>
          <td>{{$data->no_telp}}</td>
          <td><button value="{{$data->id}}" class="btn btn-icon btn-icon-only btn-outline-secondary mb-1 edit_wali" type="button" data-bs-placement="top" titte data-bs-original-title="Edit" data-bs-toggle="tooltip">
            <i class="fa-solid fa-pen-to-square"></i>
          </button>
          <button value="{{$data->id}}" class="btn btn-icon btn-icon-only btn-outline-secondary mb-1 delete_wali" type="button" data-bs-toggle="tooltip" data-bs-placement="top" titte data-bs-original-title="Hapus">
            <i class="fa-solid fa-trash-can"></i>
          </button>
          <button value="{{$data->id}}" class="btn btn-icon btn-icon-only btn-outline-secondary mb-1 view_wali" type="button" data-bs-toggle="tooltip" data-bs-placement="top" titte data-bs-original-title="View">
  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="modal-body">
          <form id="wali_form" enctype="multipart/form-data" method="post" action="">
            <div class="mb-3">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary update_wali">Save changes</button>
      </div>
      </form>
    </div>
  </div>
...
<div class="modal fade modal-close-out" id="deleteModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="modal-body">
          <form action="" id="edit_form">
            <div class="mb-3">
              <input id="delete_wali_id" type="hidden" class="name form-control" value="" />
            </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary delete_wali_btn">Delete</button>
      </div>
      </form>
    </div>
  </div>
...
<script src="{{asset('public/js/Wali.js')}}"></script>
@endsection
