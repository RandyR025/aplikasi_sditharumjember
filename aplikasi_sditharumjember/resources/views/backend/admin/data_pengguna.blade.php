        ...
        <div class="modal-body">
          <form action="{{ route('pengguna.store') }}" method="post" id="main_form" enctype="multipart/form-data">
            ...
            <div class="position-relative d-inline-block" id="singleImageUploadExample">
              <img src="{{asset('public/backend/img/profile/profile-11.jpg')}}" alt="user" class="rounded-xl border border-separator-light border-4 sw-11 sh-11" />
...
<script src="{{asset('public/js/TambahPengguna.js')}}"></script>
@endsection
@endsection