    ...
    @if($dt <= manipulasiTanggal($data[0]->deadline,'+1','months'))
        <div class="col penilaian" style="width: 300px;">
            <div class="card h-100">
                ...
                @else
                <img src="public/images/{{$data[0]->image}}" class="card-img-top sh-25" alt="card image">
                @endif
                <div class="card-body">
                    ...
                    <div class="row g-0 align-items-center mb-1">
                        <div class="col ">
                            <div class="row g-0">
                                ...
                                <div class="col-auto">
                                    <div class="sh-4 d-flex align-items-center text-alternate"><?php $jumlah = count($data);
                                                                                                echo $jumlah ?></div>
                                </div>
                            </div>
                        </div>
