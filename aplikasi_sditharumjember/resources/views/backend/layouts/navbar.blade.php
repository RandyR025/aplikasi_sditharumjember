...
@if (auth()->user()->level == "admin")
  <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <img class="profile" alt="profile" src="{{asset('public/images/'.$admin->image)}}" style="" />
    @else
    <img class="profile" alt="profile" src="{{asset('public/backend/img/profile/profile-11.jpg')}}" style="min-height: 40px !important; height: 90%!important; max-height: 100px!important; min-width: 40px !important; width: 90%!important; max-width: 100px;" />
    @endif
...
@if (auth()->user()->level == "guru")
  <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  @if (isset($guru->image))
    <img class="profile" alt="profile" src="{{asset('public/images/'.$guru->image)}}" style="" />
    @else
    <img class="profile" alt="profile" src="{{asset('public/backend/img/profile/profile-11.jpg')}}" style="min-height: 40px !important; height: 90%!important; max-height: 100px!important; min-width: 40px !important; width: 90%!important; max-width: 100px;" />
    @endif
    <div class="name" style="padding-top: 15px; padding-bottom: 5px; font-size: 15px;">{{ Auth::user()->name }}</div>
...
@if (auth()->user()->level == "wali")
  <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  @if (isset($wali->image))
    <img class="profile" alt="profile" src="{{asset('public/images/'.$wali->image)}}" style="" />
    @else
    <img class="profile" alt="profile" src="{{asset('public/backend/img/profile/profile-11.jpg')}}" style="min-height: 40px !important; height: 90%!important; max-height: 100px!important; min-width: 40px !important; width: 90%!important; max-width: 100px;" />
    @endif
    <div class="name" style="padding-top: 15px; padding-bottom: 5px; font-size: 15px;">{{ Auth::user()->name }}</div>
