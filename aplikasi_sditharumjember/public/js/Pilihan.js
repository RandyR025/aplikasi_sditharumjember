...
// }
 ...
 $(document).on('click', '.edit_pilihan', function(e){
   ...
   $.ajax({
    type: "GET",
    url: "/aplikasi_sditharumjember/edit-pilihan/"+pilihan_id,
    success: function(response){
  ...
  $(document).on("submit", "#pilihan_form", function (e) {
    ...
    $.ajax({
        type: "POST",
        url: "/aplikasi_sditharumjember/update-pilihan/" + pengisian_id,
        data: EditformData,
        contentType: false,
        processData: false,
        beforeSend: function () {
  ...
  $(document).on("click", ".delete_pilihan", function (e) {
    ...
    swalWithBootstrapButtons.fire({
      ...
      $.ajax({
          type: "DELETE",
          url: "/aplikasi_sditharumjember/delete-pilihan/" + pilihan_id,
          success: function (response) {
              console.log(response);
              $("#success_message").addClass("alert alert-success");
              $("#success_message").text(response.message);
