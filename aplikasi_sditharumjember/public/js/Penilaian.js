...
$(document).on('click', '.edit_penilaian', function(e){
   ...
   $.ajax({
    type: "GET",
    url: "/aplikasi_sditharumjember/edit-penilaian/"+penilaian_id,
    success: function(response){
      console.log(response);
...
$(document).on("submit", "#penilaian_form", function (e) {
  ...
  $.ajax({
      type: "POST",
      url: "/aplikasi_sditharumjember/update-penilaian/" + penilaian_id,
      data: EditformData,
      contentType: false,
      processData: false,
      beforeSend: function () {
...
$(document).on("click", ".delete_penilaian", function (e) {
  ...
  swalWithBootstrapButtons.fire({
    ...
    $.ajax({
        type: "DELETE",
        url: "/aplikasi_sditharumjember/delete-penilaian/" + penilaian_id,
        success: function (response) {
            console.log(response);
            // $("#success_message").addClass("alert alert-success");
            // $("#success_message").text(response.message);
